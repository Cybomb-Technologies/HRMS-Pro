  ...
  const handleLogoUpload = async (e) => {
    ...
    if (file) {
      if (file.size > 5 * 1024 * 1024) {
        handleAction('File too large - please select an image smaller than 5MB');
        return;
      }
  ...
  return (
    <Card className="p-6">
      <CardHeader className="px-0 pt-0">
        ...
        <p className="text-muted-foreground">Manage your company's basic information and branding</p>
      </CardHeader>
          ...
          <div className="flex items-start space-x-6 p-4 border rounded-lg bg-muted/20">
            <div className="flex-shrink-0">
              <div className="w-24 h-24 rounded-lg border-2 border-dashed flex items-center justify-center bg-background">
                {settingsData.logo ? (
                  <img src={settingsData.logo} alt="Company Logo" className="w-full h-full object-contain rounded-lg" />
                ) : (
            ...
            <div className="flex-1 space-y-3">
              ...
              <div className="flex space-x-3">
                ...
                {settingsData.logo && (
                  <Button variant="outline" onClick={() => updateSettings({ logo: '' })}>
